 ...
 */
public class MemoTerkirimAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MemoTerkirimAdapter(Context context, ArrayList<DataItem> modelList) {
