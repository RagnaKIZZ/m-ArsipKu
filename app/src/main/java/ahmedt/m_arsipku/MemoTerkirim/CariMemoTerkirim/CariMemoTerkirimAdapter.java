 ...
 */
public class CariMemoTerkirimAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CariMemoTerkirimAdapter(Context context, ArrayList<DataItem> modelList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            String jabter = model.getJabatanTertuju();
