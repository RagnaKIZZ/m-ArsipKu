...
import ahmedt.m_arsipku.MemoTerkirim.CariMemoTerkirim.CariMemoTerkirimActivity;
import ahmedt.m_arsipku.R;
import okhttp3.Response;


public class MemoTerkirimActivity extends AppCompatActivity{
    ...
    private MemoTerkirimAdapter mAdapter;
    ...
    private void findViews() {
        ...
        mAdapter = new MemoTerkirimAdapter(MemoTerkirimActivity.this, modelList);
        recyclerView.setHasFixedSize(true);
        // use a linear layout manager
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(mAdapter);
        mAdapter.SetOnItemClickListener(new MemoTerkirimAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, DataItem model) {
                //handle item click events here
                Intent i = new Intent(MemoTerkirimActivity.this, DetailActivity.class);
        ...
        AndroidNetworking.post(Server.getURL_MemoTerkirim)
                ...
                .getAsOkHttpResponseAndObject(MemoTerkirimModel.class, new OkHttpResponseAndParsedRequestListener<MemoTerkirimModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(MemoTerkirimActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//        searchView.setQueryHint("Cari");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                if (s.length() > 0) {
                Intent i = new Intent(MemoTerkirimActivity.this, CariMemoTerkirimActivity.class);
