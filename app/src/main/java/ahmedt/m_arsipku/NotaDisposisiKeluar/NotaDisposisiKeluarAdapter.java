 ...
 */
public class NotaDisposisiKeluarAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NotaDisposisiKeluarAdapter(Context context, ArrayList<DataItem> modelList) {
