...
import ahmedt.m_arsipku.NotaDisposisiKeluar.CariNotaDisposisiKeluar.CariNotaDisposisiKeluarActivity;
import ahmedt.m_arsipku.R;
import okhttp3.Response;


public class NotaDisposisiKeluarActivity extends AppCompatActivity{
    ...
    private void findViews() {
        ...
        mAdapter = new NotaDisposisiKeluarAdapter(NotaDisposisiKeluarActivity.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new NotaDisposisiKeluarAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, DataItem model) {
                ...
                Intent i = new Intent(NotaDisposisiKeluarActivity.this, DetailActivity.class);
        ...
        AndroidNetworking.post(Server.getURL_NotaDisposisiKeluar)
                ...
                .getAsOkHttpResponseAndObject(NotaDisposisiKeluarModel.class, new OkHttpResponseAndParsedRequestListener<NotaDisposisiKeluarModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(NotaDisposisiKeluarActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//        searchView.setQueryHint("Cari");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                if (s.length() > 0) {
                Intent i = new Intent(NotaDisposisiKeluarActivity.this, CariNotaDisposisiKeluarActivity.class);
