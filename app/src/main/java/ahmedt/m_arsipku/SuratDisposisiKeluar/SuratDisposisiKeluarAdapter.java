 ...
 */
public class SuratDisposisiKeluarAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "SuratDisposisiKeluarAda";
    ...
    public SuratDisposisiKeluarAdapter(Context context, ArrayList<DataItem> modelList) {
