...
import ahmedt.m_arsipku.SuratDisposisiKeluar.CariSuratDisposisiKeluar.CariSuratDisposisiKeluarActivity;
import okhttp3.Response;


public class SuratDisposisiKeluarActivity extends AppCompatActivity{
    ...
    private void findViews() {
        ...
        mAdapter = new SuratDisposisiKeluarAdapter(SuratDisposisiKeluarActivity.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new SuratDisposisiKeluarAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, DataItem model) {
                ...
                Intent i = new Intent(SuratDisposisiKeluarActivity.this, DetailActivity.class);
                        ...
                        if (okHttpResponse.isSuccessful()){
                            ...
                            if (response.getCode()==200){
                                ...
                                if (modelList.isEmpty()){
                                    ...
                                    Toast.makeText(SuratDisposisiKeluarActivity.this, "Tidak bisa memperbarui data", Toast.LENGTH_SHORT).show();
                                }
        ...
        AndroidNetworking.post(Server.getURL_SuratDisposisiKeluar)
                ...
                .getAsOkHttpResponseAndObject(SuratDisposisiKeluarModel.class, new OkHttpResponseAndParsedRequestListener<SuratDisposisiKeluarModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(SuratDisposisiKeluarActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//        searchView.setQueryHint("Cari");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                if (s.length() > 0) {
                Intent i = new Intent(SuratDisposisiKeluarActivity.this, CariSuratDisposisiKeluarActivity.class);
