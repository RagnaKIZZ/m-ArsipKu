...
import ahmedt.m_arsipku.DaftarNomor.DataNomorModel;
...
public class CariDataNomorActivity extends AppCompatActivity{
    ...
    private CariDataNomorAdapter mAdapter;
    ...
    private void findViews() {
        ...
        mAdapter = new CariDataNomorAdapter(CariDataNomorActivity.this, modelList);
        recyclerView.setHasFixedSize(true);
        // use a linear layout manager
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(mAdapter);
        mAdapter.SetOnItemClickListener(new CariDataNomorAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, final int position, DataItem model) {
                //handle item click events here
//                Intent i = new Intent(CariDataNomorActivity.this, DetailActivity.class);
//                i.putExtra("param", "surat_disposisi_masuk");
//                i.putExtra("data_item", modelList.get(position));
//                startActivity(i);
//                final Dialog dialog = new Dialog(CariDataNomorActivity.this);
...
//                dialog.show();
    ...
    private void setAdapter(String id, String key) {
    ...
    private void loadMore(String id, int page, String key){
        AndroidNetworking.post(Server.getURL_DataNomor)
                .addBodyParameter("id_so", id)
                ...
                .getAsOkHttpResponseAndObject(DataNomorModel.class, new OkHttpResponseAndParsedRequestListener<DataNomorModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(CariDataNomorActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
