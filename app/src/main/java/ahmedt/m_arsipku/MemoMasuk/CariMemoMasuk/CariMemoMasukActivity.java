...
import ahmedt.m_arsipku.MemoMasuk.MemoMasukAdapter;
import ahmedt.m_arsipku.MemoMasuk.MemoMasukModel;
import ahmedt.m_arsipku.R;
import okhttp3.Response;


public class CariMemoMasukActivity extends AppCompatActivity{
    ...
    private void findViews() {
        ...
        mAdapter = new MemoMasukAdapter(CariMemoMasukActivity.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new MemoMasukAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, DataItem model) {
                ...
                Intent i = new Intent(CariMemoMasukActivity.this, DetailActivity.class);
        ...
        AndroidNetworking.post(Server.getURL_MemoMasuk)
                ...
                .getAsOkHttpResponseAndObject(MemoMasukModel.class, new OkHttpResponseAndParsedRequestListener<MemoMasukModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(CariMemoMasukActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
