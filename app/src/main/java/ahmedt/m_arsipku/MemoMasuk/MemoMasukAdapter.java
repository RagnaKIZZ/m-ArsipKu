 ...
 */
public class MemoMasukAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MemoMasukAdapter(Context context, ArrayList<DataItem> modelList) {
