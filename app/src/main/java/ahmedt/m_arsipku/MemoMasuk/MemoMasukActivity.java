package ahmedt.m_arsipku.MemoMasuk;
...
import ahmedt.m_arsipku.MemoMasuk.CariMemoMasuk.CariMemoMasukActivity;
import ahmedt.m_arsipku.R;
import okhttp3.Response;


public class MemoMasukActivity extends AppCompatActivity{
    ...
    private MemoMasukAdapter mAdapter;
    ...
    private void findViews() {
        ...
        mAdapter = new MemoMasukAdapter(MemoMasukActivity.this, modelList);
        recyclerView.setHasFixedSize(true);
        // use a linear layout manager
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(mAdapter);
        mAdapter.SetOnItemClickListener(new MemoMasukAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, DataItem model) {
                //handle item click events here
                Intent i = new Intent(MemoMasukActivity.this, DetailActivity.class);
                i.putExtra("param", "memo_masuk");
    ...
    private void setAdapter(String id_so) {
        ...
        AndroidNetworking.post(Server.getURL_MemoMasuk)
                .addBodyParameter("id_so", id_so)
                .addBodyParameter("page", "1")
                .setTag("getMemoMasuk")
                .build()
                .getAsOkHttpResponseAndObject(MemoMasukModel.class, new OkHttpResponseAndParsedRequestListener<MemoMasukModel>() {
                    @Override
                    public void onResponse(Response okHttpResponse, MemoMasukModel response) {
        ...
        AndroidNetworking.post(Server.getURL_MemoMasuk)
                ...
                .getAsOkHttpResponseAndObject(MemoMasukModel.class, new OkHttpResponseAndParsedRequestListener<MemoMasukModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(MemoMasukActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//        searchView.setQueryHint("Cari");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                if (s.length() > 0) {
                Intent i = new Intent(MemoMasukActivity.this, CariMemoMasukActivity.class);
