 ...
 */
public class NotaMasukAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NotaMasukAdapter(Context context, ArrayList<DataItem> modelList) {
