 ...
 */
public class NotaDisposisiMasukAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "NotaDisposisiMasukAdap";
    ...
    public NotaDisposisiMasukAdapter(Context context, ArrayList<DataItem> modelList) {
