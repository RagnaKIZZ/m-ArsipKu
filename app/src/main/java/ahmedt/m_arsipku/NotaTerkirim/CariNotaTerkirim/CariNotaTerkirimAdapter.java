 ...
 */
public class CariNotaTerkirimAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CariNotaTerkirimAdapter(Context context, ArrayList<DataItem> modelList) {
