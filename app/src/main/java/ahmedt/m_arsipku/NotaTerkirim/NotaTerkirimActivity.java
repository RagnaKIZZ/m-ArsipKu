...
import ahmedt.m_arsipku.NotaTerkirim.CariNotaTerkirim.CariNotaTerkirimActivity;
import ahmedt.m_arsipku.R;
import okhttp3.Response;


public class NotaTerkirimActivity extends AppCompatActivity{
    ...
    private static final String TAG = "CariNotaTerkirimActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViews();
        initToolbar("Nota Dinas Terkirim");
    ...
    private void findViews() {
        ...
        mAdapter = new NotaTerkirimAdapter(NotaTerkirimActivity.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new NotaTerkirimAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, DataItem model) {
                ...
                Intent i = new Intent(NotaTerkirimActivity.this, DetailActivity.class);
                        ...
                        if (okHttpResponse.isSuccessful()){
                            ...
                            if (response.getCode()==200){
                                ...
                                if (modelList.isEmpty()){
                                    ...
                                    Toast.makeText(NotaTerkirimActivity.this, "Tidak bisa memperbarui data", Toast.LENGTH_SHORT).show();
                                }
        ...
        AndroidNetworking.post(Server.getURL_NotaTerkirim)
                ...
                .getAsOkHttpResponseAndObject(NotaTerkirimModel.class, new OkHttpResponseAndParsedRequestListener<NotaTerkirimModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(NotaTerkirimActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//        searchView.setQueryHint("Cari");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                if (s.length() > 0) {
                Intent i = new Intent(NotaTerkirimActivity.this, CariNotaTerkirimActivity.class);
