 ...
 */
public class NotaTerkirimAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NotaTerkirimAdapter(Context context, ArrayList<DataItem> modelList) {
