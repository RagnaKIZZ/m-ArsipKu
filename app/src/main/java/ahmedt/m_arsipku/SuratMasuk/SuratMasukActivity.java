...
public class SuratMasukActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViews();
        initToolbar("Kotak Masuk Surat Dinas");
                        ...
                        if (okHttpResponse.isSuccessful()){
                            ...
                            if (response.getCode()==200){
                                ...
                                if (modelList.isEmpty()){
                                    ...
                                    Toast.makeText(SuratMasukActivity.this, "Tidak bisa memperbarui data", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
    ...
    private void findViews() {
        ...
        mAdapter = new SuratMasukAdapter(SuratMasukActivity.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new SuratMasukAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, DataItem model) {
                ...
                if (!model.getPassword().isEmpty()){
                    final Dialog dialog = new Dialog(SuratMasukActivity.this);
                    ...
                    submit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (inputPass.getText().toString().equals(model.getPassword())){
                                Intent i = new Intent(SuratMasukActivity.this, DetailActivity.class);
                                i.putExtra("param", "surat_masuk");
                                i.putExtra("data_item", modelList.get(position));
                                dialog.dismiss();
                                startActivity(i);
                            }else{
                                Toast.makeText(SuratMasukActivity.this, "Password Salah!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        ...
        AndroidNetworking.post(Server.getURL_SuratMasuk)
                ...
                .getAsOkHttpResponseAndObject(SuratMasukModel.class, new OkHttpResponseAndParsedRequestListener<SuratMasukModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(SuratMasukActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//        searchView.setQueryHint("Cari");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                if (s.length() > 0) {
                Intent i = new Intent(SuratMasukActivity.this, CariSuratMasukActivity.class);
