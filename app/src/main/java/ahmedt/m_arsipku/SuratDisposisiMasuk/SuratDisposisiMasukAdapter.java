 ...
 */
public class SuratDisposisiMasukAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "SuratDisposisiMasukAdap";
    ...
    public SuratDisposisiMasukAdapter(Context context, ArrayList<DataItem> modelList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            String nosur = model.getNoRefSurat();
            String jabter = model.getNamaJabatan();
