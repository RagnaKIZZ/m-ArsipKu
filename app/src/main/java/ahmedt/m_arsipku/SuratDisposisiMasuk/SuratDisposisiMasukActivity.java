...
import ahmedt.m_arsipku.SuratDisposisiMasuk.CariSuratDisposisiMasuk.CariSuratDisposisiMasukActivity;
import okhttp3.Response;


public class SuratDisposisiMasukActivity extends AppCompatActivity{
    ...
    private void findViews() {
        ...
        mAdapter = new SuratDisposisiMasukAdapter(SuratDisposisiMasukActivity.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new SuratDisposisiMasukAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, DataItem model) {
                ...
                if (!model.getPassword().isEmpty()){
                    final Dialog dialog = new Dialog(SuratDisposisiMasukActivity.this);
                    ...
                    submit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (inputPass.getText().toString().equals(model.getPassword())){
                                Intent i = new Intent(SuratDisposisiMasukActivity.this, DetailActivity.class);
                                i.putExtra("id_dispo", model.getIdDisposisi());
                                i.putExtra("dispo", "masuk");
                                dialog.dismiss();
                                startActivity(i);
                            }else{
                                Toast.makeText(SuratDisposisiMasukActivity.this, "Password Salah!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        ...
        AndroidNetworking.post(Server.getURL_SuratDisposisiMasuk)
                ...
                .getAsOkHttpResponseAndObject(SuratDisposisiMasukModel.class, new OkHttpResponseAndParsedRequestListener<SuratDisposisiMasukModel>() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(SuratDisposisiMasukActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
...
//        searchView.setQueryHint("Cari");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                if (s.length() > 0) {
                Intent i = new Intent(SuratDisposisiMasukActivity.this, CariSuratDisposisiMasukActivity.class);
