package ahmedt.m_arsipku.SuratDisposisiMasuk.CariSuratDisposisiMasuk;
...
import ahmedt.m_arsipku.SuratDisposisiMasuk.DataItem;
import ahmedt.m_arsipku.SuratDisposisiMasuk.SuratDisposisiMasukAdapter;
import ahmedt.m_arsipku.SuratDisposisiMasuk.SuratDisposisiMasukModel;
import okhttp3.Response;


public class CariSuratDisposisiMasukActivity extends AppCompatActivity{
    ...
    private SuratDisposisiMasukAdapter mAdapter;
                        ...
                        if (okHttpResponse.isSuccessful()){
                            ...
                            if (response.getCode()==200){
                                ...
                                if (modelList.isEmpty()){
                                    ...
                                    Toast.makeText(CariSuratDisposisiMasukActivity.this, "Tidak bisa memperbarui data", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    }
    ...
    private void findViews() {
        ...
        mAdapter = new SuratDisposisiMasukAdapter(CariSuratDisposisiMasukActivity.this, modelList);
        recyclerView.setHasFixedSize(true);
        // use a linear layout manager
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(mAdapter);
        mAdapter.SetOnItemClickListener(new SuratDisposisiMasukAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, DataItem model) {
                //handle item click events here
                if (!model.getPassword().isEmpty()){
                    final Dialog dialog = new Dialog(CariSuratDisposisiMasukActivity.this);
                    ...
                    submit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (inputPass.getText().toString().equals(model.getPassword())){
                                Intent i = new Intent(CariSuratDisposisiMasukActivity.this, DetailActivity.class);
                                i.putExtra("id_dispo", model.getIdDisposisi());
                                i.putExtra("dispo", "masuk");
                                dialog.dismiss();
                                startActivity(i);
                            }else{
                                Toast.makeText(CariSuratDisposisiMasukActivity.this, "Password Salah!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
    ...
    private void loadMore(String id_so, int page, String key){
        AndroidNetworking.post(Server.getURL_SuratDisposisiMasuk)
                ...
                .addBodyParameter("key", key)
                .setTag("getSuratDisposisiMasuk_load")
                .build()
                .getAsOkHttpResponseAndObject(SuratDisposisiMasukModel.class, new OkHttpResponseAndParsedRequestListener<SuratDisposisiMasukModel>() {
                    @Override
                    public void onResponse(Response okHttpResponse, SuratDisposisiMasukModel response) {
                    ...
                    public void onError(ANError anError) {
                        ...
                        btn_loadMore.setVisibility(View.VISIBLE);
                        Toast.makeText(CariSuratDisposisiMasukActivity.this, "Jaringan atau Server Bermasalah", Toast.LENGTH_SHORT).show();
                    }
                });
    }
