 ...
 */
public class SuratTerkirimAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = "CariNotaTerkirimAdapter";
    ...
    public SuratTerkirimAdapter(Context context, ArrayList<DataItem> modelList) {
